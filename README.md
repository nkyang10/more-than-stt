...
Powered by [Sherpa-ONNX](https://github.com/k2-fsa/sherpa-onnx) — no internet required, all inference runs locally via ONNX Runtime.
...
- 🌐 **Multi-language** — auto, zh, en, yue, ja, ko
...
**Tech Stack:** .NET 10 WinForms • [Sherpa-ONNX](https://github.com/k2-fsa/sherpa-onnx) • NAudio
...
Requires Sherpa-ONNX model folder in the project root. Tests cover:
